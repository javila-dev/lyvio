...
export default {
  ...
  props: {
    ...
    // LYVIO: permite mostrar el spinner nativo del botón mientras una acción
    // async está en curso (ej. el flujo de SSO de facturación).
    actionButtonLoading: {
      type: Boolean,
      default: false,
    },
  ...
  >
    ...
    <div class="actions">
      <NextButton
        ...
        :is-loading="actionButtonLoading"
        @click="onClick"
      />
      <NextButton
        v-if="hasCloseButton"
